...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_vertical.png', 200, 450, 30,30,1),
    new Obstaculo('imagenes/valla_horizontal.png', 100, 430, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 130, 430, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 550, 370, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 760, 400, 30, 30, 1),
    //Baches:
    new Obstaculo('imagenes/bache.png',300, 80, 30, 30, 1),
    new Obstaculo('imagenes/bache.png',480, 200, 30, 30, 1),
    new Obstaculo('imagenes/bache.png',80, 280, 30, 30, 1),
    //Auto Verde:
    new Obstaculo('imagenes/auto_verde_derecha.png',420, 490, 30, 15, 1),
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png',70,200,10,10,1,{desdeX: 70, hastaX: 800, desdeY: 80, hastaY: 80}),
    new ZombieCaminante('imagenes/zombie3.png', 550,380,10,10,1,{desdeX: 400, hastaX: 560, desdeY: 350, hastaY: 600}),
    new ZombieCaminante('imagenes/zombie4.png', 200,420,10,10,1, {desdeX: 200, hastaX: 500, desdeY: 420, hastaY: 500}),
    new ZombieCaminante('imagenes/zombie3.png', 300,150,10,10,1, {desdeX: 280, hastaX: 370, desdeY: 100, hastaY: 400}),
    new ZombieCaminante('imagenes/zombie2.png', 760,380,10,10,2, {desdeX: 760, hastaX: 900, desdeY: 380, hastaY: 380}),
...
if(this.terminoJuego() || this.ganoJuego()) return;
  ...
  Dibujante.dibujarRectangulo('red', 760, 510,126, 8); // Rectangulo de llegada
